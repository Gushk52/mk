...
\033[1;96m    [𝑆𝑀𝑆 𝑀𝑂𝐷 𝐵𝑌 𝐵𝑈𝑆𝑆𝑌​​​​​​​​​​​​​​​​​​​​]​
""")
print("         \033[1;93m[ \033[1;3m\033[1;91mFacebook Page : \033[1;95mกูใจนักเลง พวกมึงใจกะหรี่กันหรา]")
print("          \033[1;93m[ \033[1;3m\033[1;91mBy : \033[1;95mFB : กูใจนักเลง พวกมึงใจกะหรี่กันหรา\033[1;93m]")
phone = input("PHONE : ")
NUM = int(input("NUM : "))
print("")
...
if (NUM < 5001):
	...
	print("\033[1;91m จำนวนไม่เกิน5000ครับ") # จำนวนไม่เกิน500 กำหนดตรง if ใส่501คือใส่จำนวนเกิน500ไม่ได้
	time.sleep(1)
